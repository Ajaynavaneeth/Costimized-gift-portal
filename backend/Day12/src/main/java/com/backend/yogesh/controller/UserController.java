...
public ResponseEntity<BasicResponse<UserResponse>> updateuser(@PathVariable int userid, @RequestBody UserRequest userRequest) {
    BasicResponse<UserResponse> response = new BasicResponse<>();
    try {
    ...
    public ResponseEntity<BasicResponse<UserResponse>> deleteUser(@PathVariable int userid) {
        BasicResponse<UserResponse> response = new BasicResponse<>();
        try {
